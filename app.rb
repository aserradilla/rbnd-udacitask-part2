...
list.all
list.delete([1,2,3], false) # Tests if you can delete multiple items
list.all
...
# ----------------------------
# new_list.add("image", "http://ruby-doc.org") # Throws InvalidItemType error (WORKS!)
# new_list.delete(9) # Throws an IndexExceedsListSize error (WORKS!)
# new_list.add("todo", "Hack some portals", priority: "super high") # throws an InvalidPriorityValue error (WORKS!)
...
# Tests the new item type, a list
# --------------------------------
new_list.add("list", "Shopping list", elements: ["Fish", "Meat", "Fruit"])
new_list.all
